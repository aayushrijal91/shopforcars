...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/main.css?v=0.7">
</head>
...
<body>
                        ...
                        <div class="row align-items-center justify-content-md-between">
                            <div class="col col-md-auto order-1 order-md-2 ps-xl-12 text-center text-lg-start">
                                <div class="row align-items-center justify-content-md-between">
                                    ...
                                    <div class="col-auto">
                                        <?= renderImg('carinspect.png', 'logo', 'd-none d-md-block') ?>
                                        <?= renderImg('carinspect-logo-small.png', 'logo', 'd-block d-md-none') ?>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script async src="https://trkcall.com/scripts/95030.js"></script>