            ...
            <div class="row gy-md-5">
                <div class="col-xl-8">
                    <div class="banner_left">
                        <div class="fs-96 lh-1 text-white font-articulat-heavy ls-2 mb-3 text-center text-md-start">More Options. More <span class="text-green">Rides.</span></div>
                ...
                <div class="col-xl-4">
                    <div class="banner_right h-100 rounded-20">
                        <div class="text-center">
                            <?= renderImg("shopforcars.png", "logo", "mb-4") ?>
                            <div class="font-articulat-heavy ls-2 fs-40 lh-1 text-white">Australia's first dealership-only car classified</div>
                            <div class="py-4 fs-20 text-white">Shop for Cars is designed to bring car dealers and car buyers together to make your next purchase simple and convenient. Shopforcars brings you quality new and second-hand vehicles.</div>
                            <div class="row align-items-center justify-content-center">
                                <div class="col-auto">
                                    <a href="https://loanoptions.ai/" target="_blank" class="btn btn-secondary d-inline-flex rounded-pill rounded-0 text-white px-4">Visit loanoptions.ai</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row h-100 align-items-center justify-content-around">
                        <div class="col-auto">
                            <svg width="49" height="50" viewBox="0 0 49 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M32.2197 18.6955L16.1098 0L0 18.6955H10.349V50H18.615V47.175H13.189V15.8705H6.17478L16.1098 4.34085L26.0449 15.8705H19.0306V23.0133H21.8706V18.6955H32.2197Z" fill="#58DE64" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M28.0482 23.4262C24.8665 23.4262 22.2873 25.9917 22.2873 29.1565C22.2873 32.3213 24.8665 34.8869 28.0482 34.8869C31.2298 34.8869 33.809 32.3213 33.809 29.1565C33.809 25.9917 31.2298 23.4262 28.0482 23.4262ZM25.1273 29.1565C25.1273 27.5519 26.435 26.2511 28.0482 26.2511C29.6613 26.2511 30.969 27.5519 30.969 29.1565C30.969 30.7611 29.6613 32.0619 28.0482 32.0619C26.435 32.0619 25.1273 30.7611 25.1273 29.1565Z" fill="#58DE64" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M37.4784 44.2696C37.4784 41.1048 40.0576 38.5392 43.2392 38.5392C46.4208 38.5392 49 41.1048 49 44.2696C49 47.4344 46.4208 49.9999 43.2392 49.9999C40.0576 49.9999 37.4784 47.4344 37.4784 44.2696ZM43.2392 41.3642C41.6261 41.3642 40.3184 42.665 40.3184 44.2696C40.3184 45.8742 41.6261 47.1749 43.2392 47.1749C44.8523 47.1749 46.16 45.8742 46.16 44.2696C46.16 42.665 44.8523 41.3642 43.2392 41.3642Z" fill="#58DE64" />
                                <path d="M27.1823 49.4934L46.3197 25.6981L44.102 23.9333L24.9646 47.7286L27.1823 49.4934Z" fill="#70BF44" />
                            </svg>
                        </div>
...
<section class="our_commitment">
    <div class="container">
        <div class="row gx-xxl-7 align-items-center gy-5">
            <div class="col-lg-6">
                <div class="fs-96 lh-3 ls-2 text-darker font-articulat-heavy">Buying a car should be fun & <span class="text-secondary">stress-free</span><span class="text-green">.</span></div>
                <div class="text-darker fs-32 fw-800 ls-2 py-3 py-md-5">Making it more simple for you<span class="text-secondary">.</span></div>
                <div class="fs-20 text-darker description">
...
<section class="more-control py-xl-10 py-md-6 py-5">
    <div class="container">
        <h2 class="fs-96 fw-800 text-dark font-articulat-heavy">More Control<span class="text-green">.</span></h2>
            ...
            <div class="bg-white shadow pt-md-5 pt-4 px-xl-7 px-md-5 px-4 pb-md-0 pb-4 rounded-20 mb-5">
                <div class="row align-items-center justify-content-between gx-5 gy-4">
                    <div class="col-md-5 order-2 order-md-1">
                        ...
                        <p class="fs-64 fw-800"><span class="text-dark">Input</span><span class="text-green">.</span></p>
            ...
            <div class="bg-white shadow pt-md-5 pt-4 px-xl-7 px-md-5 px-4 pb-md-0 pb-4 rounded-20 mb-5">
                <div class="row align-items-center justify-content-between gx-5 gy-4">
                    ...
                    <div class="col-md-5">
                        ...
                        <p class="fs-64 fw-800"><span class="text-dark">Compare</span><span class="text-green">.</span></p>
                        <div class="text-dark-grey fs-20">
            ...
            <div class="bg-white shadow pt-md-5 pt-4 px-xl-7 px-md-5 px-4 pb-md-0 pb-4 rounded-20">
                <div class="row align-items-center justify-content-between gx-5 gy-4">
                    <div class="col-md-5 order-2 order-md-1">
                        ...
                        <p class="fs-64 fw-800"><span class="text-dark">Your Choice</span><span class="text-green">.</span></p>
                        <div class="text-dark-grey fs-20">
            ...
            <div class="loans_slider" id="loans_slider">
                <div class="loan-slider-content">
                    <div class="row justify-content-between align-items-md-center h-100 gx-xl-5">
                        <div class="col-lg-7">
                            <div class="fs-64 ls-2 fw-800 lh-1 pb-3">Secured<span class="text-green">.</span></div>
                ...
                <div class="loan-slider-content">
                    <div class="row justify-content-between align-items-md-center h-100 gx-xl-5">
                        <div class="col-lg-7">
                            <div class="fs-64 ls-2 fw-800 lh-1 pb-3">Unsecured<span class="text-green">.</span></div>
...
<section class="new-used-car bg-tertiary py-xl-10 py-md-6 py-5">
    <div class="container">
        <div class="row align-items-center gx-xxl-7 gy-5">
            <div class="col-lg-6">
                <div class="fs-96 text-white font-articulat-heavy lh-3 ls-2">Buying a new or used car<span class="text-green">.</span></div>
    ...
    <div class="container">
        <div class="row align-items-center gx-xxl-7 gy-5">
            ...
            <div class="col-lg-6 order-1 order-md-2">
                <div class="fs-96 text-tertiary font-articulat-heavy lh-3 ls-2">Car loan term/period<span class="text-green">.</span></div>
    ...
    <div class="container">
        <div class="row align-items-center gx-xxl-6 gy-5">
            <div class="col-lg-6">
                ...
                <a href="#form" class="btn btn-green text-white d-inline-flex rounded-pill">Compare Car Loans</a>
            </div>
                ...
                <div class="row align-items-center gx-5">
                    <div class="col-auto d-none d-md-block">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10 5.744L8 0L6 5.744H0L4.89 9.572L2.968 15.488L8 11.832L13.032 15.488L11.11 9.572L16 5.744H10Z" fill="#58DE64" />
                        </svg>
